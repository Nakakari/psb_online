     ...
     <div class="h-100" id="leftside-menu-container" data-simplebar>
         ...
         @elseif (Auth::user()->peran == 2)
             ...
             <ul class="side-nav">
                 ...
                 <li class="side-nav-item active">
                     <a href="/siswa/home" class="side-nav-link">
                         <i class="uil-home-alt"></i>
                         <span> Dashboards </span>
                     </a>
                 </li>

                 <li class="side-nav-title side-nav-item">Pendaftaran</li>
                 @if (Auth::user()->is_kirim == 0)
                     <li class="side-nav-item">
                         <a href="/pendaftaran_siswa" class="side-nav-link">
                             <i class="uil-calender"></i>
                 ...
                 @else
                     <li class="side-nav-item">
                         <a href="/pendaftaran_siswa_sudahkirim/{{ Auth::user()->id }}" class="side-nav-link">
                             <i class="uil-calender"></i>
