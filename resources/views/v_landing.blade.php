    ...
    <nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand me-lg-5">
                <img src="{{ asset('template') }}/assets/images/logo.png" alt="" class="logo-dark"
                    height="18" />
            </a>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item me-2">
                        <a href="{{ route('register') }}"
                            class="btn btn-sm btn-light rounded-pill d-none d-lg-inline-flex">
                            <i class="mdi mdi-account-circle me-2"></i> Sign Up
                        </a>
                    </li>
                    {{-- @endif
                        @endauth
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 offset-md-2">
                    <div class="text-md-end mt-3 mt-md-0">
                        <img src="{{ asset('template') }}/assets/images/startup.svg" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5 bg-light-lighten border-top border-bottom border-light">
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-lg-4">
                    <div class="demo-box text-center">
                        <img src="{{ asset('template') }}/assets/images/layouts/layout-1.png" alt="demo-img"
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="{{ asset('template') }}/assets/images/layouts/layout-2.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="{{ asset('template') }}/assets/images/layouts/layout-3.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center">
                        <img src="{{ asset('template') }}/assets/images/layouts/layout-5.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="{{ asset('template') }}/assets/images/layouts/layout-6.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
                ...
                <div class="col-lg-4">
                    <div class="demo-box text-center mt-3 mt-lg-0">
                        <img src="{{ asset('template') }}/assets/images/layouts/layout-4.png" alt="demo-img"
                            class="img-fluid shadow-sm rounded">
    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <p class="text-muted mt-2">Hyper comes with next generation ui design and have multiple
                            benefits
                        </p>
                    </div>
                </div>
            ...
            <div class="row mt-2 py-5 align-items-center">
                <div class="col-lg-5">
                    <img src="{{ asset('template') }}/assets/images/features-1.svg" class="img-fluid"
                        alt="">
                </div>
                <div class="col-lg-6 offset-lg-1">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-muted"><i class="mdi mdi-circle-medium text-primary"></i> Ecommerce Application
                            Pages</p>
                        <p class="text-muted"><i class="mdi mdi-circle-medium text-primary"></i> Profile, pricing,
                            invoice</p>
            ...
            <div class="row pb-3 pt-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="text-muted mt-3">The simplest and fastest way to build dashboard or admin panel. Hyper is
                        built using the latest tech and tools and provide an easy way to customize anything, including
                        an overall color schemes, layout, etc.</p>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <img src="{{ asset('template') }}/assets/images/features-2.svg" class="img-fluid"
                        alt="">
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <div>
                        ...
                        <p class="faq-answer mb-4 pb-1 text-muted">Yup, the marketplace license allows you to use this
                            theme
                            in any end products.
                    ...
                    <div>
                        ...
                        <p class="faq-answer mb-4 pb-1 text-muted">Use our dedicated support email
